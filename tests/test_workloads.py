...
from format_bench.workload_contract import WorkloadDeclarations
...
def test_manifest_workload_is_not_tied_to_stars_columns() -> None:
    declarations: WorkloadDeclarations = {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"kind": "filter", "column": "name", "operator": "contains", "value": "a"},
        {"kind": "filter", "column": "name", "operator": "eq"},
        {"kind": "filter", "column": "name", "operator": "eq", "value": ["a"]},
    ],
)
