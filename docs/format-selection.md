...
| Full-text search or indexed retrieval | Lance | Lance is the tested option with a full-text index. Keep base data, index, metadata, logical directory size, and transport size separate when budgeting storage. |
